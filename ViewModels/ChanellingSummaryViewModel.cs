...
{
    public class ChanellingSummaryViewModel : ViewModelBase, SummaryViewModel
    {
        // Fields
        ...
        {
            get => _sumOfTotalCha;
            set { _sumOfTotalCha = value; OnPropertyChanged(nameof(SumOfTotalCha)); }
        }
        ...
        // Constructor
        public ChanellingSummaryViewModel()
        {
