...
{
    public class MedicalSummaryViewModel : ViewModelBase, SummaryViewModel
    {
        // Fields
        ...
        //public IEnumerable<MedicalSummary> MedicalSummaryList => throw new NotImplementedException();

        //public IEnumerable<ProcedureSummary> ProcedureSummaryList => throw new NotImplementedException();

        //public IEnumerable<LabSummary> LabSummaryList => throw new NotImplementedException();

        //public IEnumerable<ChannelSummary> ChannelSummaryList => throw new NotImplementedException();
